    ...
    <header aria-label="Page Header" className=" bg-secondary">
      <div className="max-w-screen-xl px-4 pt-8 pb-3 mx-auto sm:px-6 sm:pt-12 sm:pb-9 lg:px-8">
        <div className="sm:flex sm:items-center">
          <Image
            className="mx-auto mb-3 border-4 border-orange-500 rounded-full sm:mx-0 w-36 h-36"
            itemType=""
            width="200"
            alt="An image of Jonathan Osmond lookin' mighty dapper."
            height="200"
            src="/me_kinda_malding.jpeg"
          ></Image>
